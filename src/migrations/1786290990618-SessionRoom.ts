...
export class SessionRoom1786290990618 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."transcript_segments_source_enum" AS ENUM('ai', 'human')`);
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD "room" character varying(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."transcript_segments_source_enum"`);
    }
