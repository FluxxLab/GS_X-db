...
export class DelegateSegmentation1786614854427 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "delegates" ADD "tracks" text array NOT NULL DEFAULT '{}'`);
        await queryRunner.query(`ALTER TABLE "delegates" ADD "interests" text array NOT NULL DEFAULT '{}'`);
        await queryRunner.query(`ALTER TABLE "delegates" ADD "consentAt" TIMESTAMP WITH TIME ZONE`);
    }
